...
def players(request):
    ...
    df21['turnoverZ'] = stats.zscore(df21['TOPG'])
    ...
    df21final = df21.to_html(index=False, justify='center', columns = [
        'Name', 'Team', 'Position', 'GP', 'MPG', 'PPG', 'APG', 'RPG', 'SPG', 'BPG', '3PG', 'FG%', 'FT%', 'TOPG', 'FANTASY VALUE'
    ])
